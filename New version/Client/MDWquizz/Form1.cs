...
namespace MDWquizz
{
    public partial class Form1 : Form, IGameplayCallback
    {
        ...
        public Form1()
        {
            ...
            //richTextBoxQuestion.Text = qList[0].Details;
            //ShowOptions();
        }
        ...
        public void ShowOptions()
        {
            if (counter == 0)
            {
                ...
                /*foreach (Player p in proxy.GetPlayerList())
                {
                    if (p.PlayerID == id)
                    {
                        richTextBoxQuestion.Text = p.Counter.ToString();
                    }
                }*/
        ...
        public void ShowNextQuestion()
        {
            ...
            //richTextBoxQuestion.Text = qList[4].Details;
            ShowOptions();
            //MessageBox.Show("");
        }
