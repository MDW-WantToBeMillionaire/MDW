...
namespace userlogintest {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PlayersDataTable : global::System.Data.TypedTableBase<PlayersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PlayersRow AddPlayersRow(int Player_Id, string Player_Name) {
            ...
            private void InitClass() {
                ...
                this.columnPlayer_Name.MaxLength = 2147483647;
            }
...
namespace userlogintest.Database1DataSetTableAdapters {
    ...
    public partial class PlayersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Players] WHERE (([Player_Id] = @Original_Player_Id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Players] ([Player_Id], [Player_Name]) VALUES (@Player_Id, @Pla" +
                "yer_Name);\r\nSELECT Player_Id, Player_Name FROM Players WHERE (Player_Id = @Playe" +
                "r_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Players] SET [Player_Id] = @Player_Id, [Player_Name] = @Player_Name" +
                " WHERE (([Player_Id] = @Original_Player_Id));\r\nSELECT Player_Id, Player_Name FRO" +
                "M Players WHERE (Player_Id = @Player_Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::userlogintest.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Player_Id, Player_Name FROM dbo.Players";
        ...
        public virtual int Fill(Database1DataSet.PlayersDataTable dataTable) {
        ...
        public virtual Database1DataSet.PlayersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.PlayersDataTable dataTable = new Database1DataSet.PlayersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.PlayersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Player_Id) {
        ...
        public virtual int Insert(int Player_Id, string Player_Name) {
        ...
        public virtual int Update(int Player_Id, string Player_Name, int Original_Player_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Player_Name, int Original_Player_Id) {
            return this.Update(Original_Player_Id, Player_Name, Original_Player_Id);
        }
    }
